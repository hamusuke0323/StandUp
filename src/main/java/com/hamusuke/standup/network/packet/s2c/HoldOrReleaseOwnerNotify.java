...
public record HoldOrReleaseOwnerNotify(int standId, boolean hold) implements Packet {
    public HoldOrReleaseOwnerNotify(Stand stand, boolean hold) {
        this(stand.getId(), hold);
    }

    public HoldOrReleaseOwnerNotify(FriendlyByteBuf buf) {
