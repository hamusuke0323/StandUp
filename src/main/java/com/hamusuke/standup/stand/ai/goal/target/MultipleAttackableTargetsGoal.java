...
public class MultipleAttackableTargetsGoal<T extends LivingEntity, M extends Mob & MultipleTarget> extends TargetGoal {
    ...
    public MultipleAttackableTargetsGoal(M p_26060_, Class<T> p_26061_, boolean p_26062_) {
        this(p_26060_, p_26061_, DEFAULT_RANDOM_INTERVAL, p_26062_, false, null);
    }

    public MultipleAttackableTargetsGoal(M p_199891_, Class<T> p_199892_, boolean p_199893_, Predicate<LivingEntity> p_199894_) {
        this(p_199891_, p_199892_, DEFAULT_RANDOM_INTERVAL, p_199893_, false, p_199894_);
    }

    public MultipleAttackableTargetsGoal(M p_26064_, Class<T> p_26065_, boolean p_26066_, boolean p_26067_) {
        this(p_26064_, p_26065_, DEFAULT_RANDOM_INTERVAL, p_26066_, p_26067_, null);
    }

    public MultipleAttackableTargetsGoal(M p_26053_, Class<T> p_26054_, int p_26055_, boolean p_26056_, boolean p_26057_, @Nullable Predicate<LivingEntity> p_26058_) {
