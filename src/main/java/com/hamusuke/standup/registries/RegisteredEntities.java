...
public class RegisteredEntities {
    ...
    public static final RegistryObject<EntityType<SlimStand>> SLIM_STAND_TYPE = ENTITY_TYPES.register("slim_stand", () -> EntityType.Builder.<SlimStand>of((entityType, level) -> new SlimStand(level, null), MobCategory.MISC).noSave().noSummon().sized(0.6F, 1.8F).clientTrackingRange(32).updateInterval(2).build("slim_stand"));

    @SubscribeEvent
    public static void attributeCreation(final EntityAttributeCreationEvent event) {
